sap.ui.define([
	...
	return BaseController.extend("skurequestapp.controller.Worklist", {
		...
		onSearch: function (oEvent) {
			if (oEvent.getParameters().refreshButtonPressed) {
				...
				if (sQuery && sQuery.length > 0) {
					oTableSearchState = [new Filter("Id", FilterOperator.Contains, sQuery)];
				}
		...
		/**
		 *@memberOf skurequestapp.controller.Worklist
		 */
		 ...
		 *@memberOf skurequestapp.controller.Worklist
		 */
		OpenProgramVersionPopup: function (oEvent) {
			//This code was generated by the layout editor.
		},
		/**
		 *@memberOf skurequestapp.controller.Worklist
		 */
		onProgramVersionPopup: function (oEvent) {
			//This code was generated by the layout editor.
			
			var oPersonalizationDialog = sap.ui.xmlfragment("skurequestapp.fragments.ProgramVersionPopup", this);
